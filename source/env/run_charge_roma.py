...
if __name__ == "__main__":
    ...
    if os.path.exists("./charge_roma_log.txt"):
        with open(f"./charge_roma_log.txt", "r") as f:
            ...
            print(
                f"Resuming from total count: {total_count}, success count: {success_count}"
            )
    else:
            ...
            if vs_env.sim_step - 10 == 0:
                ...
                if score is not None and score > 0.92:
                    ...
                    if count > 10:
                        ...
                        vs_env.sim_step = 10
                        with open(f"./charge_roma_log.txt", "a") as f:
                            f.write(
