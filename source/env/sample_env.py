...
if __name__ == "__main__":
    ...
    while simulation_app.is_running():
        ...
        if vs_env.sim_step >= 10:
            ...
            if count1 >= 1000:
                break
            cv2.imwrite(f"/home/cyx/project/IsaacLab/251009-screwdriver-sim/seg/{count1:03d}-{count2:03d}.jpg", seg_image)
            cv2.imwrite(f"/home/cyx/project/IsaacLab/251009-screwdriver-sim/img/{count1:03d}-{count2:03d}.jpg", color_image)
